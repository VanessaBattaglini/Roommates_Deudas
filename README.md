...
5. Crear una API REST que contenga las siguientes rutas:
...
7. Devolver los códigos de estado HTTP correspondientes a cada situación.
   
8. Enviar un correo electrónico a todos los roommates cuando se registre un nuevo
